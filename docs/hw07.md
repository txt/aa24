...
For auto93, my RRP finds 24 _best_ so I picjed  3\*24=72 _rest_. 
...
which we can score and sort as follows. If a range is found in LIKE of the _best_ rows
