...
- Random as good as smo
  - for X in (bonr,rand) and N in (9,15,20): rand(N) == bonr(N)
  - is this result repeatable in many data sets (your class assignment)...
    - ... then we have a profound result about the nature of "how to explore the world".
